...
export default function Game(props) {
  ...
  const buttonPrevClass = cn([styles.btn, styles.prev, { [styles.disabled]: isFirstCard }]);
  const buttonNextClass = cn([styles.btn, styles.next, {[styles.disabled]: isLastCard}]);
  ...
  return (
    ...
    <div>
      <p className={styles.counter}>Изучено слов: {count} / {words.length}</p>
    </div>
    </>
  );
}
